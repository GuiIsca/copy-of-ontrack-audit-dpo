-- Adicionar Checklist AMONT 2025 (Guião Completo)
-- Este checklist implementa o guião de auditoria com 7 secções principais
-- 3 secções obrigatórias: Exterior, Frescos, Promocional
